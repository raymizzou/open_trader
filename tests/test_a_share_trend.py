...
def test_v3_drawdown_pause_blocks_only_entries_and_keeps_sell_and_hold() -> None:
    ...
    drawdown_summary = {
        ...
        "strategy_version": "v3",
        "kelly_sample_key": (
            "CN|trend_animals_warm_to_hot/CN/v3|v3"
        ),
        "state_status": "ok",
        "status": "paused",
        "status_label": "暂停新开仓",
...
def test_report_runner_sends_exact_broker_v3_text(tmp_path: Path) -> None:
    calls: list[str] = []
