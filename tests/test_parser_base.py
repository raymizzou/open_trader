...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("VIXY", "短期期貨恐慌指數ETF-Proshares", AssetClass.ETF),
        ("SMH", "半导体指数ETF-HOLDRs", AssetClass.ETF),
        ("NVDY", "NVDA期權收益策略ETF-YieldMax", AssetClass.ETF),
        ...
        ("VIXY260717C27000", "VIXY 260717 27.00C", AssetClass.OPTION),
