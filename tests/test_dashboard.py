...
def _valid_v3_dashboard_trend_payload() -> dict[str, object]:
    ...
    payload["drawdown_summary"] = {
        ...
        "strategy_id": "trend_animals_warm_to_hot/CN/v3",
        "strategy_version": "v3",
        "kelly_sample_key": "CN|trend_animals_warm_to_hot/CN/v3|v3",
        "state_status": "ok",
        "status": "active",
        "status_label": "纪律内",
        "entry_allowed": True,
...
def test_dashboard_v3_keeps_plan_risk_and_drawdown_as_separate_validated_facts(
    tmp_path: Path,
) -> None:
    config = dashboard_config(tmp_path)
    path = config.reports_dir / "trend_a_share/2026-07-15.json"
...
def test_dashboard_v3_missing_risk_contract_fails_closed(
