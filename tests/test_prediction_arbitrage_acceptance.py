...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("builder", "set_approval_async"),
        ("builder", "set_approvals"),
        ("builder", "set_ctf_exchange_allowance"),
        ("builder", "set_ctf_exchange_approval_async"),
        ("builder", "set_neg_risk_adapter_approval"),
        ("builder", "cancel_orders_async"),
        ("builder", "convert_positions"),
        ("builder", "convert_positions_async"),
        ("builder", "merge_positions_async"),
        ("builder", "redeem_positions_async"),
        ("builder", "run_approvals"),
        ("builder", "run_approvals_async"),
        ("builder", "split_positions_async"),
        ("builder", "transfer"),
        ("builder", "redemption"),
        ("client", "submit_order"),
    ),
