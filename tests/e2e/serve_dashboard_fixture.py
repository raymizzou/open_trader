...
def _observation_fixture(scenario: str) -> dict[str, object]:
    ...
    if scenario == "observation-table-titles":
        long_version = "version-" + "x" * 180
        def result() -> dict[str, object]:
            return {
                ...
                "payout": "5.00",
                "net_amount": "0.10",
                "net_roi": "0.02040816326530612",
                "last_attempt_at": "2026-08-03T15:40:02Z",
                "last_success_at": "2026-08-03T15:40:01Z",
            }
        rows = [
            {
                "identity": "same-event-full",
                "event_id": "987654321",
                "event": "987654321",
                "event_title": "987654321",
                "title": "Will Aurora win the full game?",
                "question": "Will Aurora win the full game?",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "OBSERVING",
                "version_id": long_version,
                "version_fingerprint": "fingerprint-full-" + "x" * 120,
                "approval_status": "APPROVED",
                "end_date": "2026-08-18T00:00:00Z",
                "capital_release_status": "UNKNOWN",
                "tokens": ["full-yes", "full-no"],
            ...
            {
                "identity": "same-event-first-half",
                "event_id": "987654321",
                "event": "987654321",
                "event_title": "987654321",
                "title": "Will Aurora win the first half?",
                "question": "Will Aurora win the first half?",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "OBSERVING",
                "version_id": long_version,
                "version_fingerprint": "fingerprint-first-half-" + "x" * 120,
                "approval_status": "APPROVED",
                "end_date": "2026-08-18T00:00:00Z",
                "capital_release_status": "UNKNOWN",
                "tokens": ["first-half-yes", "first-half-no"],
                "oldest_book_at": "2026-08-03T15:40:01Z",
                "last_attempt_at": "2026-08-03T15:40:02Z",
                "last_success_at": "2026-08-03T15:40:01Z",
                "result": result(),
    ...
    if scenario == "observation-table-membership":
        def result(status: str, current: bool, cost: str, payout: str, net: str, roi: str, reason: str | None = None) -> dict[str, object]:
            return {
                "status": status,
                "current": current,
                "quantity": "1",
        ...
        rows = [
            {
                ...
                "event_id": "pool-positive-id",
                "title": "Pool positive market",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "OBSERVING",
                "version_id": "v-positive",
                "approval_status": "APPROVED",
                "end_date": "2026-08-18T00:00:00Z",
                "tokens": ["pool-positive-yes", "pool-positive-no"],
                "result": result("PASS", True, "1.00", "1.25", "0.25", "0.25"),
            },
            {
                "identity": "pool-negative",
                "event_id": "pool-negative-id",
                "title": "Pool negative market",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "OBSERVING",
                "version_id": "v-negative",
                "approval_status": "APPROVED",
                "end_date": "2026-08-19T00:00:00Z",
                "tokens": ["pool-negative-yes", "pool-negative-no"],
                "result": result("PASS", True, "3.00", "2.50", "-0.50", "-0.1666666667"),
            },
            {
                "identity": "pool-blocked",
                "event_id": "pool-blocked-id",
                "title": "Pool blocked market",
                "relation_type": "EXACTLY_ONE",
                "stage": "OBSERVING",
                "version_id": "v-blocked",
                "approval_status": "APPROVED",
                "end_date": "2026-08-20T00:00:00Z",
                "tokens": ["pool-blocked-yes", "pool-blocked-no", "pool-blocked-draw"],
                "result": result("BLOCKED", False, "2.25", "2.25", "0.00", "0", "STALE_BOOK"),
            },
            {
                "identity": "waiting-market",
                "event_id": "waiting-id",
                "title": "Waiting market",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "WAITING",
                "version_id": "v-waiting",
                "approval_status": "PENDING",
                "end_date": "2026-08-21T00:00:00Z",
                "tokens": ["waiting-yes", "waiting-no"],
                "result": result("PASS", True, "1.00", "1.10", "0.10", "0.10"),
            },
            {
                "identity": "excluded-current",
                "event_id": "excluded-current-id",
                "title": "Excluded current must stay hidden",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "EXCLUDED",
                "version_id": "v-excluded-current",
                "approval_status": "REJECTED",
                "result": result("PASS", True, "1.00", "1.30", "0.30", "0.30"),
            },
            {
                "identity": "rejected-stale",
                "event_id": "rejected-stale-id",
                "title": "Rejected stale must stay hidden",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "REJECTED",
                "version_id": "v-rejected-stale",
                "approval_status": "REJECTED",
                "result": result("BLOCKED", False, "4.00", "4.00", "0.00", "0", "STALE_BOOK"),
            },
        ]
        members = rows[:3]
        return {
    ...
    if scenario == "observation-table-pending-quote":
        pending = {
            "identity": "pending-quote-pool",
            "event_id": "pending-quote-id",
            "title": "Pending quote pool member",
            "relation_type": "NATIVE_COMPLEMENT",
            "stage": "PENDING_QUOTE",
            "version_id": "v-pending-quote",
            "approval_status": "APPROVED",
            "end_date": "2026-08-22T00:00:00Z",
            "tokens": ["pending-quote-yes", "pending-quote-no"],
        }
        return {
            "n_leg_coverage": {
                "source_scope": "官方来源 · 已发现范围",
    ...
    if scenario == "observation-table-identity-fallback":
        row = {
            "identity": "relation-only-fallback",
            "relation_type": "NATIVE_COMPLEMENT",
            "stage": "OBSERVING",
            "version_id": "v-relation-only",
            "approval_status": "APPROVED",
            "result": {
                "status": "BLOCKED",
                "current": False,
                "reason": "UNKNOWN_MODEL_FACTS",
            },
        }
        return {
            "n_leg_coverage": {
    ...
    if scenario == "observation-table-history":
        rows = [
            {
                "identity": "history-current-positive",
                "event_id": "history-current-id",
                "title": "Current positive market",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "OBSERVING",
            ...
            {
                "identity": "history-stale-positive",
                "event_id": "history-stale-id",
                "title": "Stale previous positive market",
                "relation_type": "NATIVE_COMPLEMENT",
                "stage": "OBSERVING",
                "version_id": "v-stale",
                "approval_status": "APPROVED",
            ...
            {
                "identity": "history-never-computed",
                "event_id": "history-never-computed-id",
                "title": "Blocked never computed market",
                "relation_type": "EXACTLY_ONE",
                "stage": "OBSERVING",
                "version_id": "v-never-computed",
                "approval_status": "APPROVED",
                "end_date": "2026-08-20T00:00:00Z",
                "result": {
                    "status": "BLOCKED",
