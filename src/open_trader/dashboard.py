...
def _valid_trend_risk_summary(payload: dict[str, Any]) -> bool:
    ...
    if summary is None:
        return strategy_version not in {"v2", "v3", "v4", "v5", "v6", "v7", "v8"}
    if not isinstance(summary, dict) or any(
        isinstance(value, (dict, list)) for value in summary.values()
    ):
        return False
    if strategy_version not in {"v2", "v3", "v4", "v5", "v6", "v7", "v8"}:
    ...
    *,
    ...
    for item in buys:
        ...
        if (
            ...
            or strategy_version in {"v3", "v4", "v5", "v6", "v7", "v8"}
    ...
    for item in judgments["risk_skips"]:
        ...
        zero_kelly_skip = (
            strategy_version in {"v3", "v4", "v5", "v6", "v7", "v8"}
