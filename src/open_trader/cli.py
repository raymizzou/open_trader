...
def build_parser() -> argparse.ArgumentParser:
    ...
    trend_curve_backtest_parser.add_argument("--database", type=Path, required=True)
    trend_curve_backtest_parser.add_argument("--prices", type=Path, required=True)
    trend_curve_backtest_parser.add_argument(
        "--market", choices=("US",), required=True
    )
    trend_curve_backtest_parser.add_argument("--symbol", required=True)
    trend_curve_backtest_parser.add_argument(
    ...
    trend_curve_backtest_parser.add_argument(
        "--initial-cash", type=positive_decimal, required=True
    )
    trend_curve_backtest_parser.add_argument(
